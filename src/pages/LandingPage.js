    ...
    async function checkIfMetamaskAccountIsConnected() {
        try {
            ...
            if (accounts.length !== 0) {
                setConnectedMetamaskAccount(accounts[0]);
            }
        } catch (error) {
            console.log(error);
        }
                    ...
                    <div style={{
                        ...
                        <div>
                            ...
                            <div className='mt-16' >
                                ...
                                {
                                    !connectedMetamaskAccount
                                        ?
                                        <div className='flex flex-row mt-2 md:mt-1 cursor-pointer items-center ' onClick={() => connectMetamask()} >
                                            <p className='font-bold text-[#2F5B48] text-[18px] ' >Connect wallet</p>
                                            <img src={Chevron} />
                                        </div>
                                        :
                                        <div className='flex flex-row mt-2 md:mt-1 cursor-pointer items-center ' onClick={() => navigate("/order-print")} >
                                            <p className='font-bold text-[#2F5B48] text-[18px] ' >Get the print</p>
                                            <img src={Chevron} />
                                        </div>
                                }
